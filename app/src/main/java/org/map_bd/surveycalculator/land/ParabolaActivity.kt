...
import org.map_bd.surveycalculator.databinding.ActivityParabolaBinding

class ParabolaActivity : AppCompatActivity() {
    private lateinit var binding: ActivityParabolaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityParabolaBinding.inflate(layoutInflater)
