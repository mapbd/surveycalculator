...
import org.map_bd.surveycalculator.databinding.ActivityTrapeziumBinding

class TrapeziumActivity : AppCompatActivity() {

    private lateinit var binding: ActivityTrapeziumBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTrapeziumBinding.inflate(layoutInflater)
