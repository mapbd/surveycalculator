...
import org.map_bd.surveycalculator.databinding.ActivityHeronsRuleBinding

class HeronsRuleActivity : AppCompatActivity() {

    private lateinit var binding: ActivityHeronsRuleBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityHeronsRuleBinding.inflate(layoutInflater)
