...
import org.map_bd.surveycalculator.databinding.ActivityDistributionoflandBinding

class DistributionoflandActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDistributionoflandBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDistributionoflandBinding.inflate(layoutInflater)
