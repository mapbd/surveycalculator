...
import org.map_bd.surveycalculator.databinding.ActivityEllipseBinding

class EllipseActivity : AppCompatActivity() {

    private lateinit var binding: ActivityEllipseBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityEllipseBinding.inflate(layoutInflater)
