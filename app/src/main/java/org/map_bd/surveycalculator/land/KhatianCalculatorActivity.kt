...
class KhatianCalculatorActivity : AppCompatActivity() {

    private lateinit var binding: ActivityKhatianCalculatorBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityKhatianCalculatorBinding.inflate(layoutInflater)
